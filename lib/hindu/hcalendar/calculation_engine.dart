...
class HinduCalculationEngine {
  ...
  static double getMoonLongitude(double julianDay) {
    double t = (julianDay - 2451545.0) / 36525.0;
    double l = 218.3164477 + t * (481267.88123421 - t * (0.0015786 + t * (1.0/538841.0 - t/65194000.0)));
    double m = 134.9633964 + t * (477198.8675055 + t * (0.0087472 + t * (1.0/69699.0) - t/14712000.0));
    double mp = 357.5291092 + t * (35999.0502909 - t * (0.0001536 + t/24490000.0));
    double d = 297.8501921 + t * (445267.1114034 - t * (0.0018819 - t/545868.0 + t/113065000.0));
    double f = 93.2720950 + t * (483202.0175233 - t * (0.0036539 - t/3526000.0 + t/863310000.0));
  ...
  static Map<String, dynamic> calculateHinduDate(int year, int month, int day, {double latitude = 0.0, double longitude = 0.0}) {
